// AXI4 write/read control top — state machine arbitrating DDR3 read and write transactions
...
module wr_rd_ctrl_top # (
    ...
    input                        clk         ,
    input                        rstn        ,
// interaction w/ top layer (WR / RD FIFO)
    input                        wr_cmd_en   ,
    ...
    input  [MEM_DQ_WIDTH*8-1:0]  wr_cmd_data ,
    output                       wr_cmd_data_req,
...
// interaction w/ bottom layer (DDR3 IP CORE)              
    // write channel                            
    ...
    wire                        wr_bac     /* remove from module output */      ;
    ...
    wr_cmd_trans#(
        ...
        .wr_cmd_data      (  wr_cmd_data      ),//input  [MEM_DQ_WIDTH*8-1:0]      wr_cmd_data,
        .wr_data_req      (  wr_cmd_data_req  ),//output reg                       wr_data_req,
