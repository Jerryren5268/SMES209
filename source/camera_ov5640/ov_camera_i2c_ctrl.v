// I2C write controller for OV5640 sensor register configuration (SCCB protocol)
// 24-bit transfer: device_addr(8) + reg_addr(8) + reg_data(8)

module ov_camera_i2c_ctrl
(              clock_i2c        ,  //i2c控制接口传输所需时钟，0-400khz，此处为20khz
               camera_rstn      ,     
               ack              ,  //应答信号
