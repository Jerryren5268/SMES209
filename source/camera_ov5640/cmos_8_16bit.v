// 8-bit to 16-bit pixel converter with clock divider
// Combines two consecutive 8-bit bytes into one 16-bit RGB565 pixel
// Output pixel_clk = pclk / 2 (gated by first VSYNC rising edge)
