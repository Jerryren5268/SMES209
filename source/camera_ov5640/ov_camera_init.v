// OV5640 power-on sequencing: 5ms Pwdn hold → 1.3ms Reset hold → 21ms SCCB init delay
// Generates camera_rstn, camera_pwnd, and initial_en for downstream I2C configuration

`timescale 1ns / 1ps

module ov_camera_init(
    input  clk_50M        ,
    input  reset_n        ,
    output camera_rstn    ,
    output camera_pwnd    ,
